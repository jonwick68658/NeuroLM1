...
class ModelService:
    ...
    def __init__(self):
        ...
        self.default_models = [{
            ...
            "description":
            "Fast inference via Cerebras - Default"
        }, {
            "id":
            "openai/gpt-4o-mini",
            "name":
            "GPT-4o Mini",
            "description":
            "Fast and efficient model for general chat"
        }, {
            ...
            if response.status_code == 200:
                ...
                for model in models_data.get("data", []):
                    models.append({
                        ...
                        model.get("id", ""),
                        "name":
                        model.get("name", model.get("id", "Unknown")),
                        "description":
    ...
    async def chat_completion(
            self,
            messages: List[Dict],
            model: str = "cerebras/llama-4-scout-17b-16e-instruct") -> str:
        ...
        if not self.api_key:
            raise Exception(
                "OpenRouter API key is required for chat completions")
