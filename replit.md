...
- July 14, 2025: **403 FORBIDDEN ERROR IDENTIFIED**: Cloud Run service deployed but blocked by organization policy restrictions. Root cause: IAM policy blocking external access to all endpoints. Solution: Run fix_gcp_403_errors.sh script in Google Cloud Shell to update organization policies and Cloud Run IAM permissions. Account reset completed - Username: Ryan, Email: ryantodd306@gmail.com, Password: test123.
